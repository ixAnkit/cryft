...
go build -v -ldflags="-X 'github.com/ixAnkit/cryft/cmd.Version=$VERSION' -X github.com/ixAnkit/cryft/pkg/utils.telemetryToken=$TELEMETRY_TOKEN" $extra_build_args -o $BIN
